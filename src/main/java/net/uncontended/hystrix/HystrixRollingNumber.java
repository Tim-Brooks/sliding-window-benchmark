 ...
 */
package net.uncontended.hystrix;
...
public class HystrixRollingNumber {
    ...
    final AtomicInteger timeInMilliseconds;
    final AtomicInteger numberOfBuckets;
    ...
    public HystrixRollingNumber(int timeInMilliseconds, int numberOfBuckets) {
        this.timeInMilliseconds = new AtomicInteger(timeInMilliseconds);
        this.numberOfBuckets = new AtomicInteger(numberOfBuckets);
